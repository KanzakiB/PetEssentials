...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    if (isset($_POST['button_login']) && $_POST['button_login'] == 'signin') 
    {
        ...
        $check_email_sql = "SELECT * FROM admin_account WHERE admin_email='$admin_email'";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/PetEssentials/backend/css/admin_login.css">

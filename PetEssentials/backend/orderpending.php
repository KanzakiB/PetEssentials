    ...
    <div class="flex">
        ...
        <main class="flex-1 p-4 sm:p-6 md:p-8 ml-24 sm:ml-8 md:ml-16 lg:ml-64 transition-all duration-300">
            ...
            <div class="container mx-auto p-4">
                <h1 class="text-2xl font-bold mt-10 mb-4 text-pink-800">Pending Orders</h1>
                        ...
                        <table class="min-w-full table-auto border-collapse border border-purple-200">
                            <thead class="bg-[#FD9596]">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left text-sm font-medium text-white">Customer</th>
                                    ...
                                    <tr class="hover:bg-[#ffe2fa]">
                                        ...
                                        <td class="px-4 py-2">
                                            <div class="flex space-x-2">
                                                <button onclick="openOrderDetailsModal(<?php echo $order['orderID']; ?>)" 
                                                    class="text-blue-600 hover:underline">
                                                    View Details
                                                </button>
                                                <select onchange="updateOrderStatus(this, <?php echo $order['orderID']; ?>)" 
        ...
        <div class="bg-white rounded-lg shadow-xl w-11/12 max-w-2xl max-h-[90vh] overflow-y-auto">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button onclick="closeOrderDetailsModal()" class="text-red-500 hover:text-red-700">

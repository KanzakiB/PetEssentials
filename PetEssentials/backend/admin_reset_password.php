...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($lengthValid && $capitalValid && $numberValid && $specialValid) {
        if ($new_password === $confirm_password) {
            ...
            $sql = "UPDATE admin_account SET admin_passw='$hashed_password' WHERE admin_email='$email'";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/PetEssentials/backend/css/admin_resetpw.css">

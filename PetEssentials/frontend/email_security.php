...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_verification_email'])) {
    ...
    $verificationLink = "http://localhost/PetEssentials/frontend/customer_email.php"; 
...
<div class="main-container">
    <div class="profile-info-container">
        ...
        <p>For security reasons, we require identity verification to update your email.</p>
        <form method="POST">
